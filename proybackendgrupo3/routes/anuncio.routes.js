...
router.post('/busqueda/', authController.verifyToken, anuncioController.getAnuncioFiltro);
router.get('/busqueda2',authController.verifyToken,anuncioController.getAnuncioFiltro);
