...
export class AnuncioService {
  ...
  public getAnunciosFiltro(roles:Array<string>,titulo:string,fecha:Date,destinatarios:string,medio:string,redactor:string,estado:string,tipoContenido:string):Observable<any>{
    const httpOptions = {
      headers: new HttpHeaders({
        "Content-Type": "application/json"
      }),
      params: {
        'roles': roles,
        'titulo': titulo,
        'fechaSalidaVigencia':fecha.toISOString(),
